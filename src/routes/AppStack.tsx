...
import CadastroEnderecoEntrega from '../pages/ListaEnderecoEntrega/CadastroEnderecoEntrega'
    ...
    return (
        <NavigationContainer>
            <Navigator screenOptions={{ headerShown: false }}>
                ...
                <Screen name="CadastroEnderecoEntrega" component={CadastroEnderecoEntrega} />
